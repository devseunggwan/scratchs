...
session = sf_connector.get_session().__next__()
...
def summarize_question_with_history(chat_history, question):
    ...
    prompt = f"""
        ...
        with the chat history provided. The query should be in korean language. 
    ...
    df_response = session.sql(
        cmd, params=[st.session_state.model_name, prompt]
    ).collect()
